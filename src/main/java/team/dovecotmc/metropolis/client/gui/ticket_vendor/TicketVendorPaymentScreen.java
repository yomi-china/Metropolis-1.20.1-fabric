...
public class TicketVendorPaymentScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.textRenderer.drawWithOutline(
                MALocalizationUtil.translatableText("gui.metropolis.ticket_vendor_payment.title").asOrderedText(),
                intoTexturePosX(36),
                intoTexturePosY(12),
                0xFFFFFF,
                0x16161B,
...
//        float scaleFactor = 8f / textRenderer.fontHeight;
        ...
        // Description price
        Text priceText = MALocalizationUtil.translatableText("gui.metropolis.ticket_vendor_payment.price", paymentData.value);
//        scaleFactor = 1f;
        matrices.push();
        matrices.scale(scaleFactor, scaleFactor, scaleFactor);
        this.textRenderer.drawWithShadow(
        ...
        Text balanceText = MALocalizationUtil.translatableText("gui.metropolis.ticket_vendor_payment.balance", balance);
        this.textRenderer.drawWithShadow(
                matrices,
                balanceText,
                intoTexturePosX(x0) / scaleFactor,
        ...
        matrices.push();
        matrices.scale(scaleFactor, scaleFactor, scaleFactor);
        Text continueText = MALocalizationUtil.translatableText("gui.metropolis.ticket_vendor_payment.continue_button");
        textRenderer.draw(
                matrices,
                continueText,
